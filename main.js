...
function openSettings() {
	...
	f.id = "set"
	f.innerHTML = "<h1>Settings</h1><p>Remove the values to see what the inputs are for. If you don't want to save what you have entered then refresh the page.<br><br>For more editor related settings, enter ctrl+',' or cmd+',' or on mobile, use the ... button, open palette and select settings</p>"
...
function full() {
	...
	open("/compress.html?" + encodeURIComponent(htm))
}
setTimeout(() => {
	e.setOptions({
		enableLiveAutocompletion: true,
